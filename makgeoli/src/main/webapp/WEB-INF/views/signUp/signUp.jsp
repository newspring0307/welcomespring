...
<div class="padding-container">
<form name="signupsave" action="signUpSave.do" method="post"> 
    <div class="login-box">
<h3> 회원가입 </h3> 
...
아이디  <br>
<input name='id' id='id' type='text' size="20" ><br/>
비밀번호  <br>
<input name='pw' type='password' size="20"><br/>
비밀번호 재확인 <br>
<input name='pass_confirm' type='password' size="20"><br/>
생년월일  <br>
<input id="birth" name="birth" type="text" size="20"><br/>
휴대전화  <br>
<input name='tel' type='text' size="20"><br/>

<!--   <a href="../signUpSave/signUpSave.do"/><b>가입하기</b></a> -->
 <button type="submit" name="button" class="submit-btn">가입하기</button></br>
   </div>
 </form>
</div>
