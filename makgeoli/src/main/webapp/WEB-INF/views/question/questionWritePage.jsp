...
<div class="my_container">
   ...
   <center>
      <form action="questionSave.do"></br>
      <table>   
      
           <input type="hidden" name="id" value="${id}">
      <tr> 
       <td><b>제목</b>
           <input type="text" name="title" size='70' placeholder="제목을 입력해주세요"></td>
      </tr>
        <td><b>문의내용</b></td>
        
      <tr>
        <th><textarea name="content" style="width:450px;height:200px;font-size:13px; resize: none" placeholder="내용을 입력해주세요" ></textarea></th>
      </tr>
      </table>
   
        <div class="box-flex">
          <button type="submit" name="button" class="submit-btn">글작성</button></br>
        </div>
       </form>
   </center>
