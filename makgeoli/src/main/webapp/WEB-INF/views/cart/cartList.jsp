...
<c:choose>
	...
	<c:otherwise>
	<form name="form1" id="form1" method="post" action="../jumun/jumunInsert.do">
		<table border="1">
			<tr>
				<th>상품명</th>
				<th>단가</th>
				...
				<th>취소</th>
					...
					<input type="hidden" name="jumunFirstName" value="상품" min="1">
...
<!-- 					<input type="hidden" name="jumunFirstName" value="상품" min="1"> -->
<%-- 					<input type="hidden" name="jumunFirstName" value="${1.productName}" min="1"> --%>
				...
				<td>
					...
					<input type="hidden" name="jumunFirstName" value="${row.productId}">
				</td>
...
<%-- 			<input type="hidden" name="jumunAmount" value="${map.count}" min="1"> --%>
			<input type="hidden" name="jumunAmount" value="${map.allAmount}" min="1">
				<input type="hidden" name="jumunSum" value="${map.allSum}" min="1">
			<tr>
		...
		<button type="submit" id="btnUpdate">구매하기</button>
		</form>
		</c:otherwise>
		</c:choose>


<a href="../product/productList.do">쇼핑 계속하기</a>
</center>
        </section>
