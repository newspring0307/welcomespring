...
<c:choose>
	...
	<c:otherwise>
	<form name="form1" id="form1" method="post" action="jumun/updateCart.do">
		<table border="1">
			<tr>
				<th>주문일자</th>
				<th>주문요약</th>
			...
			<c:forEach var="row" items="${jumunList}" varStatus="i">
			<tr>
				<td>
					${row.regDate}
				</td>
<!-- 				<td style="width: 80px" align="right"> -->
<%-- 					<fmt:formatNumber pattern="###,###,###" value="${1.productName+" 외 " +count+ " 건 "}"/> --%>
				</td>
				<td style="width: 80px" align="right">
					${row.jumunSum}
				</td>
...
<a href="../cart/getCartList.do">장바구니 확인하기</a>
